...
public class JsonTraverser
{
	...
	public double visit(JsonObject node, List<Double> values) throws JsonException;
    }
     ...
     */
    public void traverse(JsonObject node, JsonVisitorDouble postOrderVisitor) throws JsonException
    {
     ...
     * @throws JsonException
     */
    public void traversePostOrder(JsonObject node, JsonVisitor postOrderVisitor) throws JsonException
    {
     ...
     * @throws JsonException
     */
    public void traversePreOrder(JsonObject node, JsonVisitor preOrderVisitor) throws JsonException
    {
    ...
    private void traverseImpl(JsonObject node, JsonVisitor preOrderVisitor, JsonVisitor postOrderVisitor) throws JsonException
    {
	if (preOrderVisitor != null)
	{
	...
	if (childNode != JsonValue.NULL)
	{
	    ...
	    {
		traverseImpl(children.get(i).asObject(), preOrderVisitor, postOrderVisitor);
	    }
	}
    ...
    private double traverseImpl(JsonObject node, JsonVisitorDouble postOrderVisitor) throws JsonException
    {
