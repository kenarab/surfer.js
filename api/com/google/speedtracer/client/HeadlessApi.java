...
public class HeadlessApi
{
     ...
     * @param cb callback to be triggered when the action is complete.
     */
    public static native void startMonitoring(MonitoringOnOptions options, MonitoringCallback cb) /*-{
												  $wnd.speedtracer.startMonitoring(options, function() {
												  if (cb) {
												  @com.google.speedtracer.client.HeadlessApi::fireMonitoringCb(Lcom/google/speedtracer/client/HeadlessApi$MonitoringCallback;)(cb);
												  }
												  });
												  }-*/;
    ...
    private static native void nativeGetDump(GetDumpCallback cb) /*-{
								 ...
								 @com.google.speedtracer.client.HeadlessApi::fireDumpCb(Lcom/google/speedtracer/client/HeadlessApi$GetDumpCallback;Ljava/lang/String;)(cb, dumpData);
								 });
								 }-*/;
