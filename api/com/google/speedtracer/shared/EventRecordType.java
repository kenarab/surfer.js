...
public class EventRecordType
{
    ...
    private static final String[] webkitTypeStrings= { "Dom Event", // 0 DOM_EVENT
    ...
    private static final String[] speedTracerTypeStrings= { "AGGREGATED Events", // 0x7FFFFFFF AGGREGATED_EVENTS
