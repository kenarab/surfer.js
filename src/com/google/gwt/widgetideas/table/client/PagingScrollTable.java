...
public class PagingScrollTable<R> extends ScrollTable implements SourceRowPagingEvents
{
	 ...
	 */
	public VisibleRowsIterator(Iterator<Iterator<Object>> rows, int firstRow, int firstVisibleRow, int lastVisibleRow)
	{
    ...
    {
	this(tableModel, dataTable, headerTable, GWT.<ScrollTableImages> create(ScrollTableImages.class));
    }
     ...
     */
    public PagingScrollTable(TableModel<R> tableModel, FixedWidthGrid dataTable, FixedWidthFlexTable headerTable, ScrollTableImages images)
    {
	...
	CellEditInfo<R> editInfo= new CellEditInfo<R>(getDataTable(), row, column, getRowValue(row));
	...
	if (rows != null && rows.hasNext())
	{
	    ...
	    Iterator<Iterator<Object>> visibleIter= new VisibleRowsIterator(rows, firstRow, firstVisibleRow, lastVisibleRow);
