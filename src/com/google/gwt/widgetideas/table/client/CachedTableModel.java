...
public class CachedTableModel<R> extends TableModel<R>
{
	 ...
	 */
	public CacheCallback(Request request, Callback<R> callback, int startRow, int numRows)
	{
	...
	public void onRowsReady(Request request, Response<R> response)
	{
	    ...
	    actualCallback.onRowsReady(actualRequest, new CacheResponse(actualStartRow, actualStartRow + actualNumRows - 1));
	}
    }
