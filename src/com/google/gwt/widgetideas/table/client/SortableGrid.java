...
public class SortableGrid extends SelectionGrid
{
	 ...
	 */
	public abstract void onSortColumn(SortableGrid grid, ColumnSortList sortList, ColumnSorterCallback callback);
    }
	...
	deselectAllRows();
	getColumnSorter(true).onSortColumn(this, columnSortList, new ColumnSorterCallback(selectedRows));
    }
