...
public class ScrollTable extends ComplexPanel implements ResizableWidget, SourcesScrollEvents
{
	...
	switch (DOM.eventGetType(event))
	{
		...
		{
		    scrollListeners.fireScroll(this, dataWrapper.getScrollLeft(), dataWrapper.getScrollTop());
		}
		break;
	...
	int numColumns= Math.max(headerTable.getColumnCount() - getHeaderOffset(), dataTable.getColumnCount());
    ...
    {
	if (columnResizePolicy == ColumnResizePolicy.DISABLED || resizePolicy == ResizePolicy.FILL_WIDTH || resizePolicy == ResizePolicy.FIXED_WIDTH)
	{
