...
public class TableSelectionListenerCollection extends ArrayList<TableSelectionListener>
{
     ...
     * @param cell the cell index
     */
    public void fireCellUnhover(SourceTableSelectionEvents sender, int row, int cell)
    {
	for (TableSelectionListener listener : this)
	{
     ...
     */
    public void fireRowsSelected(SourceTableSelectionEvents sender, int firstRow, int numRows)
    {
	for (TableSelectionListener listener : this)
	{
