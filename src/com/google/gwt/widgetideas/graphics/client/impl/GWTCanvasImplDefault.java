...
public class GWTCanvasImplDefault implements GWTCanvasImpl
{
    ...
    public native void drawImage(ImageElement img, double sourceX, double sourceY, double sourceWidth, double sourceHeight, double destX, double destY, double destWidth, double destHeight) /*-{
