...
public class PathElement
{
    ...
    public static String arc(double x, double y, double radius, double startAngle, double endAngle, boolean antiClockwise, GWTCanvasImplIE6 canvas)
    {
    ...
    public static String bezierCurveTo(double c1x, double c1y, double c2x, double c2y, double x, double y, GWTCanvasImplIE6 canvas)
    {
	double[] matrix= canvas.matrix;
	return CUBIC + canvas.getCoordX(matrix, c1x, c1y) + "," + canvas.getCoordY(matrix, c1x, c1y) + "," + canvas.getCoordX(matrix, c2x, c2y) + "," + canvas.getCoordY(matrix, c2x, c2y) + "," + canvas.getCoordX(matrix, x, y) + "," + canvas.getCoordY(matrix, x, y);
    }
    ...
    {
	double[] matrix= canvas.matrix;
	return LINETO + canvas.getCoordX(matrix, x, y) + "," + canvas.getCoordY(matrix, x, y);
    }

    public static String moveTo(double x, double y, GWTCanvasImplIE6 canvas)
    {
	double[] matrix= canvas.matrix;
	return MOVETO + canvas.getCoordX(matrix, x, y) + "," + canvas.getCoordY(matrix, x, y);
    }

    private static String arcImpl(double x, double y, double radius, double startAngle, double endAngle, boolean antiClockwise, GWTCanvasImplIE6 canvas)
    {
	...
	startX= (x + Math.cos(startAngle) * (ar - GWTCanvasImplIE6.subPixelFactorHalf));
	startY= (y + Math.sin(startAngle) * (ar - GWTCanvasImplIE6.subPixelFactorHalf));
	...
	return arcType + GWTCanvasImplIE6.doubleToFlooredInt(cx - arcX + 0.5f) + "," + GWTCanvasImplIE6.doubleToFlooredInt(cy + arcY + 0.5f) + " " + GWTCanvasImplIE6.doubleToFlooredInt(cx + arcX + 0.5f) + "," + GWTCanvasImplIE6.doubleToFlooredInt(cy - arcY + 0.5f) + " " + canvas.getCoordX(matrix, startX, startY) + "," + canvas.getCoordY(matrix, startX, startY) + " " + canvas.getCoordX(matrix, endX, endY) + "," + canvas.getCoordY(matrix, endX, endY);
    }
}