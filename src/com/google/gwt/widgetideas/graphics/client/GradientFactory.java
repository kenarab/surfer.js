...
public interface GradientFactory
{
    ...
    CanvasGradient createLinearGradient(double x0, double y0, double x1, double y1, Element c);

    CanvasGradient createRadialGradient(double x0, double y0, double r0, double x1, double y1, double r1, Element c);
}
