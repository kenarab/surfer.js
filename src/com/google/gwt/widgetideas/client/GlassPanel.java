...
public class GlassPanel extends Composite implements EventPreview
{
	...
	if (!GWT.isScript())
	{
		...
		{
		    String msg= "SORRY: GlassPanel cannot properly cover a " + nodeName + " element in quirks mode due to CSS restrictions in certain browsers." + " Please consider using standards mode or try using a different type of element.";
