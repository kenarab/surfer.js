...
public class Simplificator extends AbstractVisitor<PolynomialOperation, Void>
{
    ...
    public Map<String, java.lang.Double> getDict()
    {
	return dict;
    }

    public void setDict(Map<String, java.lang.Double> dict)
    {
	this.dict= dict;
    }
	...
	try
	{
	    if (((DoubleValue) firstOperand).value1 == 0.0)
	...
	try
	{
	    if (((DoubleValue) secondOperand).value1 == 0.0)
		return firstOperand;
	}
	catch (ClassCastException cce)
	{
	...
	try
	{
	    if (((DoubleValue) firstOperand).value1 == 0.0)
		return firstOperand;
	    else if (((DoubleValue) firstOperand).value1 == 1.0)
		return secondOperand;
	}
	catch (ClassCastException cce)
	{
	...
	try
	{
	    if (((DoubleValue) secondOperand).value1 == 0.0)
		return secondOperand;
	    else if (((DoubleValue) secondOperand).value1 == 1.0)
		return firstOperand;
	}
	catch (ClassCastException cce)
	{
	...
	try
	{
	    double dBase= ((DoubleValue) base).value1;
	...
	try
	{
	    return new DoubleValue(-((DoubleValue) operand).value1);
	}
	catch (ClassCastException cce)
	{
	...
	try
	{
	    return new DoubleValue(((DoubleValue) dividend).value1 / ((DoubleValue) divisor).value1);
	}
	...
	try
	{
	    double firstValue= ((DoubleValue) firstOperand).value1;
	    double secondValue= ((DoubleValue) secondOperand).value1;
	    double result;
	...
	try
	{
	    double value= ((DoubleValue) operand).value1;
	    double result;
