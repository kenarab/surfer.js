...
public class TransformedPolynomialRowSubstitutorForGradient implements RowSubstitutorForGradient
{
    ...
    public TransformedPolynomialRowSubstitutor getTprs_px()
    {
	return tprs_px;
    }

    public void setTprs_px(TransformedPolynomialRowSubstitutor tprs_px)
    {
	this.tprs_px= tprs_px;
    }

    public TransformedPolynomialRowSubstitutor getTprs_py()
    {
	return tprs_py;
    }

    public void setTprs_py(TransformedPolynomialRowSubstitutor tprs_py)
    {
	this.tprs_py= tprs_py;
    }

    public TransformedPolynomialRowSubstitutor getTprs_pz()
    {
	return tprs_pz;
    }

    public void setTprs_pz(TransformedPolynomialRowSubstitutor tprs_pz)
    {
	this.tprs_pz= tprs_pz;
    }
